...
const CreateWeeklyExercise = () => {
    ...
    async function createExercise() {
        ...
        await API.graphql({ query: createWeeklyExercise, variables: { input: formData } });
    ...
    return Auth.user ? (
        <div id="CreateWeeklyExercise">
                    ...
                    <tr>
                        <td>
                            <input
                                ...
                                type="number"
                                onChange={e => setFormData({ ...formData, 'dayOfWeekNum': e.target.value})}
                        ...
                        <td>
                            <input
                                ...
                                type="number"
                                onChange={e => setFormData({ ...formData, 'exerciseNum': e.target.value})}
            ...
            <button onClick={createExercise}>Create Weekly Exercise</button>
